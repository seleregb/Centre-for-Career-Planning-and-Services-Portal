# Production Environment Variables - Database
...
# postgresql_server_name      = "ccps-portal-psql-prod"  # Must be globally unique
...
# mysql_server_name           = "ccps-portal-mysql-prod"  # Must be globally unique
